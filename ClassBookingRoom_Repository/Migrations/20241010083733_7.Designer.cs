            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Cohort", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CohortCode = "K17",
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7962),
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7963),
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7938),
                            Name = "IT",
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7939),
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7903),
                            RoomName = "101",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7903),
                            isDeleted = false
                        },
                        new
                        {
                            Id = -2,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7906),
                            RoomName = "102",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7906),
                            isDeleted = false
                        },
                        new
                        {
                            Id = -3,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7908),
                            RoomName = "103",
                            RoomTypeId = -1,
                            Status = "Closed",
                            UpdatedAt = new DateTime(2024, 10, 10, 8, 37, 33, 115, DateTimeKind.Utc).AddTicks(7908),
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.RoomType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7704),
                            Name = "RoomT1",
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(7715),
                            isDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("10c8e332-3aab-455e-8fae-afd90778898c"),
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8025),
                            DepartmentId = -1,
                            ...
                            Role = "Admin",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8028),
                            isDeleted = false
                        },
                        new
                        {
                            Id = new Guid("0d2a4edf-f2d9-4b42-8f93-811e3a505aee"),
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8032),
                            DepartmentId = -1,
                            ...
                            Role = "Manager",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8034),
                            isDeleted = false
                        },
                        new
                        {
                            Id = new Guid("3d364edc-51b1-4bdc-ba41-543da4624ad6"),
                            CohortId = -1,
                            CreateAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8037),
                            DepartmentId = -1,
                            ...
                            Role = "Student",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 10, 15, 37, 33, 115, DateTimeKind.Local).AddTicks(8038),
                            isDeleted = false
                        });
                });
