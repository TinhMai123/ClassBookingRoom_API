...
namespace ClassBookingRoom_Repository.Migrations
{
    ...
    [Migration("20241006104156_Migration_3")]
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Cohort", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CohortCode = "K17",
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9509),
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9510)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9492),
                            Name = "IT",
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9493)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9460),
                            RoomName = "101",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9460)
                        },
                        new
                        {
                            Id = -2,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9466),
                            RoomName = "102",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9466)
                        },
                        new
                        {
                            Id = -3,
                            Capacity = 10,
                            CreateAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9468),
                            RoomName = "103",
                            RoomTypeId = -1,
                            Status = "Closed",
                            UpdatedAt = new DateTime(2024, 10, 6, 10, 41, 55, 199, DateTimeKind.Utc).AddTicks(9468)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.RoomType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9275),
                            Name = "RoomT1",
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9287)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cc52c92d-7858-4200-844b-f46c0eddd025"),
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9568),
                            DepartmentId = -1,
                            ...
                            Role = "Admin",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9571)
                        },
                        new
                        {
                            Id = new Guid("01636116-5a61-45c0-b5ae-dc03d066caf1"),
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9574),
                            DepartmentId = -1,
                            ...
                            Role = "Manager",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9576)
                        },
                        new
                        {
                            Id = new Guid("fe8e75b5-19e7-4833-9557-8c7a45fc2efb"),
                            CohortId = -1,
                            CreateAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9579),
                            DepartmentId = -1,
                            ...
                            Role = "Student",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 6, 17, 41, 55, 199, DateTimeKind.Local).AddTicks(9580)
                        });
                });
