...
namespace ClassBookingRoom_Repository.Migrations
{
    ...
    [Migration("20241016111225_migration_6")]
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Cohort", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CohortCode = "K17",
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1343),
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1345)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1260),
                            IsDeleted = false,
                            Name = "IT",
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1264)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            Capacity = 10,
                            CreatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1133),
                            IsDeleted = false,
                            Picture = "",
                            RoomName = "101",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1134)
                        },
                        new
                        {
                            Id = -2,
                            Capacity = 10,
                            CreatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1142),
                            IsDeleted = false,
                            Picture = "",
                            RoomName = "102",
                            RoomTypeId = -1,
                            Status = "Open",
                            UpdatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1143)
                        },
                        new
                        {
                            Id = -3,
                            Capacity = 10,
                            CreatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1146),
                            IsDeleted = false,
                            Picture = "",
                            RoomName = "103",
                            RoomTypeId = -1,
                            Status = "Closed",
                            UpdatedAt = new DateTime(2024, 10, 16, 11, 12, 24, 251, DateTimeKind.Utc).AddTicks(1147)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.RoomType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(641),
                            IsDeleted = false,
                            Name = "RoomT1",
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(662)
                        });
                });
            ...
            modelBuilder.Entity("ClassBookingRoom_Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9bdf04d1-75ab-400a-81fe-ab0d3399696b"),
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1506),
                            DepartmentId = -1,
                            ...
                            Role = "Admin",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1515)
                        },
                        new
                        {
                            Id = new Guid("40fd9286-0995-4d49-90a1-6371db487206"),
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1525),
                            DepartmentId = -1,
                            ...
                            Role = "Manager",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1529)
                        },
                        new
                        {
                            Id = new Guid("2ef14666-40c4-4a22-bdd7-4aa811696abc"),
                            CohortId = -1,
                            CreatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1538),
                            DepartmentId = -1,
                            ...
                            Role = "Student",
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 10, 16, 18, 12, 24, 251, DateTimeKind.Local).AddTicks(1550)
                        });
                });
